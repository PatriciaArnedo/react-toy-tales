  ...
  render() {
    return (
      <div className="card">
        ...
        <button className="like-btn" onClick={this.likeClickHandler}>Like {'<3'}</button>
        <button className="del-btn" onClick={this.deleteClickHandler}>Donate to GoodWill</button>
      </div>
    );
  }
